...
public class MavenCommandLineBuilder {
	...
	if (userSettingsFile != null) {
		...
		logger.debug("Failed to canonicalize user settings path: " + userSettingsFile.getAbsolutePath() + ". Using as-is.", e);
	    }
	...
	if (globalSettingsFile != null) {
		...
		logger.debug("Failed to canonicalize global settings path: " + globalSettingsFile.getAbsolutePath() + ". Using as-is.", e);
	    }
	...
	if (toolchainsFile != null) {
		...
		logger.debug("Failed to canonicalize toolchains path: " + toolchainsFile.getAbsolutePath() + ". Using as-is.", e);
	    }
	...
	if (pomSpecified) {
		...
		logger.debug("Specified POM file is not named \'pom.xml\'. " + "Using the \'-f\' command-line option to accommodate non-standard filename...");
	...
	if (localRepositoryDirectory != null) {
		...
		logger.debug("Failed to canonicalize local repository directory: " + localRepositoryDirectory + ". Using as-is.", e);
	    }
