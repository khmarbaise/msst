...
import com.soebes.shared.cli.invoker.CommandLineConfigurationException;
import com.soebes.shared.cli.invoker.DefaultInvocationRequest;
import com.soebes.shared.cli.invoker.InvocationRequest;
import com.soebes.shared.cli.invoker.MavenCommandLineBuilder;

public class MavenCommandLineBuilderTest extends TestCase {
	...
	public void testWrapwithQuotes() {
		...
		assertEquals("\"bunch of spaces in here\"",
				tcb.wrapStringWithQuotes(test));
	...
	public void testShouldFailToSetLocalRepoLocationGloballyWhenItIsAFile()
		...
		File lrd = File.createTempFile("workdir-test", "file")
				.getCanonicalFile();
	...
	public void testShouldFailToSetLocalRepoLocationFromRequestWhenItIsAFile()
		...
		try {
			tcb.setEnvironmentPaths(
					newRequest().setLocalRepositoryDirectory(lrd), cli);
			fail("Should not set local repo location to point to a file.");
		} catch (IllegalArgumentException e) {
			assertTrue(true);
		}
	...
	public void testShouldSetLocalRepoLocationGlobally() throws Exception {
		logTestStart();
		...
		assertArgumentsPresentInOrder(cli, "-D",
				"maven.repo.local=" + lrd.getPath());
	}
	...
	public void testShouldSetLocalRepoLocationFromRequest() throws Exception {
		...
		tcb.setEnvironmentPaths(newRequest().setLocalRepositoryDirectory(lrd),
				cli);
	...
	private File setupTempMavenHomeIfMissing() throws Exception {
	...
	public void testActivateReactorIncludesExcludes() {
		...
		tcb.setReactorBehavior(
				newRequest().activateReactor(includes, excludes), cli);
	...
	public void testProjectsAndAlsoMake() {
		...
		tcb.setReactorBehavior(
				newRequest().setProjects(Collections.singletonList("proj1"))
						.setAlsoMake(true), cli);
	...
	public void testProjectsAndAlsoMakeDependents() {
		...
		tcb.setReactorBehavior(
				newRequest().setProjects(Collections.singletonList("proj1"))
						.setAlsoMakeDependents(true), cli);
	...
	public void testProjectsAndAlsoMakeAndAlsoMakeDependents() {
		...
		tcb.setReactorBehavior(
				newRequest().setProjects(Collections.singletonList("proj1"))
						.setAlsoMake(true).setAlsoMakeDependents(true), cli);
	...
	public void testShouldSetStrictChecksumPolityFlagFromRequest() {
		...
		tcb.setFlags(
				newRequest().setGlobalChecksumPolicy(
						InvocationRequest.CHECKSUM_POLICY_FAIL), cli);
	...
	public void testShouldSetLaxChecksumPolicyFlagFromRequest() {
		...
		tcb.setFlags(
				newRequest().setGlobalChecksumPolicy(
						InvocationRequest.CHECKSUM_POLICY_WARN), cli);
	...
	public void testShouldSetFailAtEndFlagFromRequest() {
		...
		tcb.setReactorBehavior(
				newRequest().setFailureBehavior(
						InvocationRequest.REACTOR_FAIL_AT_END), cli);
	...
	public void testShouldSetFailNeverFlagFromRequest() {
		...
		tcb.setReactorBehavior(
				newRequest().setFailureBehavior(
						InvocationRequest.REACTOR_FAIL_NEVER), cli);
	...
	public void testShouldUseDefaultOfFailFastWhenSpecifiedInRequest() {
		...
		tcb.setReactorBehavior(
				newRequest().setFailureBehavior(
						InvocationRequest.REACTOR_FAIL_FAST), cli);
	...
	public void testShouldSpecifyFileOptionUsingNonStandardPomFileLocation()
		...
		File projectDir = new File(base, "file-option-nonstd-pom-file-location")
				.getCanonicalFile();

		projectDir.mkdirs();

		File pomFile = createDummyFile(projectDir, "non-standard-pom.xml")
				.getCanonicalFile();
	...
	public void testShouldSpecifyFileOptionUsingNonStandardPomInBasedir()
		...
		File projectDir = new File(base, "file-option-nonstd-basedir")
				.getCanonicalFile();

		projectDir.mkdirs();

		File basedir = createDummyFile(projectDir, "non-standard-pom.xml")
				.getCanonicalFile();
	...
	public void testShouldNotSpecifyFileOptionUsingStandardPomFileLocation()
		...
		File projectDir = new File(base, "std-pom-file-location")
				.getCanonicalFile();

		projectDir.mkdirs();

		File pomFile = createDummyFile(projectDir, "pom.xml")
				.getCanonicalFile();
	...
	public void testShouldNotSpecifyFileOptionUsingStandardPomInBasedir()
		...
		File projectDir = new File(base, "std-basedir-is-pom-file")
				.getCanonicalFile();

		projectDir.mkdirs();

		File basedir = createDummyFile(projectDir, "pom.xml")
				.getCanonicalFile();
	...
	public void testShouldUseDefaultPomFileWhenBasedirSpecifiedWithoutPomFileName()
		...
		File projectDir = new File(base, "std-basedir-no-pom-filename")
				.getCanonicalFile();
	...
	public void testShouldSpecifyPomFileWhenBasedirSpecifiedWithPomFileName()
		...
		File projectDir = new File(base, "std-basedir-with-pom-filename")
				.getCanonicalFile();
	...
	public void testShouldSpecifyCustomUserSettingsLocationFromRequest()
		...
		TestCommandLineBuilder tcb = new TestCommandLineBuilder();
		tcb.setSettingsLocation(newRequest().setUserSettingsFile(settingsFile),
				cli);
	...
	public void testShouldSpecifyCustomGlobalSettingsLocationFromRequest()
		...
		TestCommandLineBuilder tcb = new TestCommandLineBuilder();
		tcb.setSettingsLocation(newRequest()
				.setGlobalSettingsFile(settingsFile), cli);
	...
	public void testShouldSpecifyCustomToolchainsLocationFromRequest()
		...
		File projectDir = new File(base, "custom-toolchains")
				.getCanonicalFile();
		...
		TestCommandLineBuilder tcb = new TestCommandLineBuilder();
		tcb.setToolchainsLocation(newRequest()
				.setToolchainsFile(toolchainsFile), cli);
	...
	public void testShouldSpecifyCustomPropertyFromRequest() throws IOException {
		logTestStart();
	...
	public void testShouldSpecifySingleGoalFromRequest() throws IOException {
		logTestStart();
	...
	public void testShouldSpecifyTwoGoalsFromRequest() throws IOException {
		logTestStart();
	...
	public void testShouldSpecifyThreadsFromRequest() throws IOException {
		logTestStart();
	...
	public void testBuildTypicalMavenInvocationEndToEnd() throws Exception {
		...
		File projectDir = new File(tmpDir,
				"invoker-tests/typical-end-to-end-cli-build");
		...
		assertEquals(projectDir.getCanonicalPath(), commandline
	...
	public void testShouldInsertActivatedProfiles() throws Exception {
		...
		assertArgumentsPresentInOrder(commandline, "-P", profile1 + ","
				+ profile2);
	}
	...
	private static final class TestCommandLineBuilder extends
		...
		public void setEnvironmentPaths(InvocationRequest request,
				Commandline cli) {
		...
		public void setReactorBehavior(InvocationRequest request,
				Commandline cli) {
			super.setReactorBehavior(request, cli);
		}

		public void setSettingsLocation(InvocationRequest request,
				Commandline cli) {
			super.setSettingsLocation(request, cli);
		}

		public void setShellEnvironment(InvocationRequest request,
