...
public class MavenCommandLineBuilderTest extends TestCase {
    ...
    public void testShouldFailToSetLocalRepoLocationGloballyWhenItIsAFile() throws IOException {
	logTestStart();
    ...
    public void testShouldFailToSetLocalRepoLocationFromRequestWhenItIsAFile() throws IOException {
	logTestStart();
    ...
    public void testShouldSpecifyFileOptionUsingNonStandardPomInBasedir() throws Exception {
	logTestStart();
    ...
    public void testShouldSpecifyCustomPropertyWithSpacesInValueFromRequest() throws IOException {
	logTestStart();
    ...
    public void testShouldSpecifyCustomPropertyWithSpacesInKeyFromRequest() throws IOException {
	logTestStart();
	...
	assertEquals("Arguments: " + expected + " were not found or are in the wrong order: " + Arrays.asList(arguments), expected.size(), expectedCounter);
    }
    ...
    private static final class TestCommandLineBuilder extends MavenCommandLineBuilder {
	public void checkRequiredState() throws IOException {
	    super.checkRequiredState();
	}

	public File findMavenExecutable() throws CommandLineConfigurationException, IOException {
	...
	public void setShellEnvironment(InvocationRequest request, Commandline cli) throws CommandLineConfigurationException {
