...
public interface Invoker {
	 ...
	 *         <code>null</code> if using the default Maven installation.
	 */
	File getMavenHome();

	/**
	 * Sets the path to the base directory of the Maven installation used to
	 * invoke Maven. This parameter may be left unspecified to use the default
	 * Maven installation which will be discovered by evaluating the system
	 * property <code>maven.home</code> and the environment variable
	 * <code>M2_HOME</code>.
	 * 
	 * @param mavenHome
	 *            The path to the base directory of the Maven installation, may
	 *            be <code>null</code> to use the default Maven installation.
