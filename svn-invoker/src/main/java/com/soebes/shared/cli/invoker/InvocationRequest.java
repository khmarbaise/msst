...
public interface InvocationRequest {
	 ...
	 * be propagated to the SVN invocation. By default, the current
	 * environment variables are inherited by the new SVN invocation.
	 * 
	 ...
	 * 
	 * @return The input stream used to provide input for the invoked SVN
	 *         build or <code>null</code> if not set.
	 */
	InputStream getInputStream(InputStream defaultStream);

	/**
	 * Gets the handler used to capture the standard output from the SVN
	 * build.
	 * 
