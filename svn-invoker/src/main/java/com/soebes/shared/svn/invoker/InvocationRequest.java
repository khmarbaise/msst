...
public interface InvocationRequest {
     ...
     * only affects the working directory for the Maven invocation.
     *
     * @param defaultDirectory The default base directory to use if none is configured for
     ...
     *
     * @param basedir The path to the base directory of the POM, may be
     ...
     *
     * @param properties The system properties for the Maven invocation, may be
     *                   <code>null</code> if not set.
     * @return This invocation request.
     */
     ...
     *
     * @param shellEnvironmentInherited <code>true</code> if the environment variables should be
     *                                  propagated, <code>false</code> otherwise.
     * @return This invocation request.
     */
     ...
     *
     * @param name  The name of the environment variable, must not be
     *              <code>null</code>.
     * @param value The value of the environment variable, must not be
     *              <code>null</code>.
     * @return This invocation request.
     */
