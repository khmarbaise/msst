...
public class SubversionCommandLineBuilder {
    ...
    protected void setFlags(InvocationRequest request, Commandline cli) {
        ...
        // TODO: What about config-dir, config-option ?
    ...
    protected File findSVNExecutable() throws CommandLineConfigurationException {
        ...
        if (fullyQualifiedExecutable != null) {
            logger.debug("File location " + fullyQualifiedExecutable.getAbsolutePath());
        } else {
            throw new CommandLineConfigurationException("svn executable not found at: " + fullyQualifiedExecutable);
    ...
    /**
     * {@code subversionExecutable} ??
     * 
     * @param subversionExecutable
     *            the executable
     */
    public void setSubversionExecutable(File svnExecutable) {
